                    ...
                    <div class="col-md-7 col-lg-8 col-xl-9">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="profile-code.php" method="post">
                                    <div class="row form-row">
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label>Name</label>
                                                <input type="text" name="name" class="form-control" value="<?php echo $_SESSION['patient']['name'] ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                <label>Phone number</label>
                                                <input type="text" name="phone" class="form-control" value="<?php echo $_SESSION['patient']['phone'] ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                                            <label>Address</label>
                                                <input type="text" name="address" class="form-control" value="<?php echo $_SESSION['patient']['address'] ?>" required>
                                            </div>
                                        </div>
                                    </div>
